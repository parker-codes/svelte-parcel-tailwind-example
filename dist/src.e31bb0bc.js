...
function get_store_value(store) {
  ...
  if (unsubscribe.unsubscribe) unsubscribe.unsubscribe();else unsubscribe();
  return value;
}
...
},{}],"components/Counter.svelte":[function(require,module,exports) {
"use strict";
...
/* components/Counter.svelte generated by Svelte v3.6.7 */
function create_fragment(ctx) {
  var button, t, dispose;
  return {
    c() {
      button = (0, _internal.element)("button");
      t = (0, _internal.text)(ctx.count);
      (0, _internal.attr)(button, "class", "p-2 bg-gray-300 border-2 border-gray-500 rounded");
      dispose = (0, _internal.listen)(button, "click", ctx.increment);
    },
    ...
    p(changed, ctx) {
      if (changed.count) {
        (0, _internal.set_data)(t, ctx.count);
      }
    },
...
class Counter extends _internal.SvelteComponent {
  constructor(options) {
    super();
...
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs"}],"App.svelte":[function(require,module,exports) {
"use strict";
...
var _Counter = _interopRequireDefault(require("./components/Counter.svelte"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

/* App.svelte generated by Svelte v3.6.7 */
function create_fragment(ctx) {
  var h1, t_1, current;
  ...
  return {
    c() {
      ...
      t_1 = (0, _internal.space)();
      counter.$$.fragment.c();
    },

    m(target, anchor) {
      (0, _internal.insert)(target, h1, anchor);
      (0, _internal.insert)(target, t_1, anchor);
      (0, _internal.mount_component)(counter, target, anchor);
      current = true;
    },
    ...
    i(local) {
      if (current) return;
      (0, _internal.transition_in)(counter.$$.fragment, local);
      current = true;
    },

    o(local) {
      (0, _internal.transition_out)(counter.$$.fragment, local);
      current = false;
    },
    ...
    d(detaching) {
      if (detaching) {
        ...
        (0, _internal.detach)(t_1);
      }

      (0, _internal.destroy_component)(counter, detaching);
    }
...
var _default = App;
exports.default = _default;
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs","./components/Counter.svelte":"components/Counter.svelte"}],"css/tailwind.css":[function(require,module,exports) {
...
},{"./App.svelte":"App.svelte","./css/tailwind.css":"css/tailwind.css"}]},{},["index.js"], null)
